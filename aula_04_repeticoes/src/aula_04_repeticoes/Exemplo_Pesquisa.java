...
public class Exemplo_Pesquisa {
	...
	while(continua == 'S') {
		...
		do {
		System.out.println("\nEscolha o seu Esporte favorito: ");
		...
		// Total de pessoas que gostam de voleibol e sao maiores de 18
	...
	System.out.printf("Total de pessoas maiores de 18 que gostam de voleibol: %d\n", voleiM18);
